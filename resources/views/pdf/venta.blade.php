...
<body>
    ...
    <header>
        <div id="logo">
            <img src="img/logo-klarens.png" alt="Klarens" id="imagen">
        </div>
        <div id="datos">
            <p id="encabezado">
                <b>KLARENS</b><br>Magdalena - San Sebastián, Colombia<br>Telefono:(+57) 931742904<br>Email:klarens.sansebastian@gmail.com
            </p>
        </div>
        <div id="fact">
