                    ...
                    <template v-else-if="listado == 0">
                        <div class="card-body">
                            <div class="form-group row border">
                                <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <v-select :on-search="selectProveedor" label="nombre" :options="arrayProveedor" placeholder="Buscar Proveedores..." :onChange="getDatosProveedor">
                                ...
                                <div class="col-md-12">
                                    <div v-show="errorIngreso" class="form-group row div-error">
                                        <div class="alert alert-danger" v-for="error in errorMostrarMsjIngreso" :key="error" v-text="error">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row border">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">Artículo <span class="text-error" v-show="idarticulo == 0">(*Seleccione)</span></label>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="">Precio <span class="text-error" v-show="precio == 0">(*Ingrese)</span></label>
                                        <input type="number" value="0" step="50" class="form-control" v-model="precio">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="">Cantidad <span class="text-error" v-show="cantidad == 0">(*Ingrese)</span></label>
                                    ...
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        <tbody v-if="arrayDetalle.length">
                                            <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                                ...
                                                <td>
                                                    <input v-model="detalle.precio" type="number" value="1000" step="50" class="form-control">
                                                </td>
                                                <td>
    ...
    export default {
        ...
        methods : {
            ...
            validarIngreso(){
                ...
                if(this.tipo_comprobante == 0) this.errorMostrarMsjIngreso.push('Seleccione un tipo de comprobante');
                if(!this.num_comprobante) {
                    let actual = new Date();
                    this.num_comprobante = actual.getMonth()+1 + actual.getDate().toString() + actual.getHours().toString() + actual.getMinutes().toString() + actual.getSeconds().toString();
                }
                if(!this.impuesto) this.impuesto = 0;
                if(this.arrayDetalle.length <= 0) this.errorMostrarMsjIngreso.push('Ingrese artículos');
